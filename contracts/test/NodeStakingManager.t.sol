...
contract NodeStakingManagerTest is Test {
    ...
    function setUp() public {
        ...
        // Set prices
        priceOracle.setPrice(address(elizaOS), 0.10 ether); // $0.10
    ...
    function testGetOperatorNodes() public {
        ...
        bytes32 node1 = staking.registerNode(address(elizaOS), 10000 ether, address(elizaOS), "https://n1.com", INodeStakingManager.Region.NorthAmerica);
        bytes32 node2 = staking.registerNode(address(elizaOS), 10000 ether, address(elizaOS), "https://n2.com", INodeStakingManager.Region.Europe);
        bytes32 node3 = staking.registerNode(address(elizaOS), 10000 ether, address(elizaOS), "https://n3.com", INodeStakingManager.Region.Asia);
    ...
    function testGetNetworkStats() public {
        ...
        vm.startPrank(alice);
        elizaOS.approve(address(staking), 10000 ether);
        staking.registerNode(address(elizaOS), 10000 ether, address(elizaOS), "https://n1.com", INodeStakingManager.Region.NorthAmerica);
        vm.stopPrank();
        
        vm.startPrank(bob);
        clanker.approve(address(staking), 50 ether);
        staking.registerNode(address(clanker), 50 ether, address(virtualToken), "https://n2.com", INodeStakingManager.Region.Europe);
        vm.stopPrank();
    ...
    function testMultipleOperatorsSimultaneously() public {
        ...
        vm.startPrank(alice);
        elizaOS.approve(address(staking), 10000 ether);
        bytes32 aliceNode = staking.registerNode(address(elizaOS), 10000 ether, address(elizaOS), "https://alice.com", INodeStakingManager.Region.NorthAmerica);
        vm.stopPrank();
        
        // Bob stakes CLANKER
        vm.startPrank(bob);
        clanker.approve(address(staking), 50 ether);
        bytes32 bobNode = staking.registerNode(address(clanker), 50 ether, address(virtualToken), "https://bob.com", INodeStakingManager.Region.Europe);
        vm.stopPrank();
    ...
    function testSlashingReducesStake() public {
        ...
        elizaOS.approve(address(staking), 10000 ether);
        bytes32 nodeId = staking.registerNode(address(elizaOS), 10000 ether, address(elizaOS), "https://slash-test.com", INodeStakingManager.Region.NorthAmerica);
    ...
    function testPauseStopsRegistrations() public {
        ...
        vm.expectRevert();
        staking.registerNode(address(elizaOS), 10000 ether, address(elizaOS), "https://paused.com", INodeStakingManager.Region.NorthAmerica);
