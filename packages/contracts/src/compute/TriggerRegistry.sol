...
contract TriggerRegistry is Ownable, ReentrancyGuard {
    ...
    event TriggerRegisteredWithAgent(bytes32 indexed triggerId, address indexed owner, uint256 indexed agentId, string name);
