...
export default {
  ...
  aiSummary: {
    ...
    projectContext: `
     We are Jeju Network. Our mission is to build a robust, decentralized blockchain network that powers next-generation applications. We focus on scalability, security, and developer experience, providing the infrastructure for Web3 applications.

  Core Philosophy
    Decentralization & Security: Building a trustless, secure network that empowers users.
    Developer Experience: Creating tools and frameworks that make blockchain development accessible and efficient.
    Scalability & Performance: Ensuring the network can handle real-world application demands.
    Community-Driven: Growing an engaged ecosystem of contributors and users.
    `,
  },
