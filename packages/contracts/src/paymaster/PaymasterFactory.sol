...
contract PaymasterFactory is Ownable {
    ...
    function deployPaymaster(
        ...
        // Wire up contracts BEFORE transferring ownership
        ...
        // Set fee margin BEFORE transferring ownership (factory owns it now)
        _paymaster.emergencySetFeeMargin(feeMargin);
        
        // NOW transfer ownership (contracts are fully configured)
