...
contract MobSystem is System {
     ...
     */
    function spawnMob(uint8 mobType, int32 x, int32 y, int32 z, uint16 spawnIndex) public returns (bytes32 mobId) {
        ...
        (uint32 maxHealth, uint8 attackLevel, uint8 strengthLevel, uint8 defenseLevel, uint8 rangedLevel) =
            _getMobStats(mobType);
