...
Settlement: Base Sepolia (84532) → Jeju Testnet (420690)  
Time: 2-4 hours

## Prerequisites

- [ ] AWS account
- [ ] Base Sepolia ETH (0.5+ on deployer)
...
# Transaction
cast send 0x... --value 0.01ether --rpc-url http://localhost:8545 --private-key $KEY
```
