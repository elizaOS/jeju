...
contract GameContractsTest is Test {
    ...
    function setUp() public {
        ...
        governance = new RegistryGovernance(
            payable(address(registry)), address(mockPredimarket), owner, RegistryGovernance.Environment.LOCALNET, owner
        );
    ...
    function test_GameIntegration_CannotReinitialize() public {
        ...
        gameIntegration.initialize(
            address(banManager), address(registry), address(items), address(gold), address(0), address(0), 1
        );
    }
    ...
    function test_GameIntegration_PlayerBanned_NetworkLevel() public {
        ...
        banManager.banFromNetwork(player1AgentId, "Cheating - network ban", bytes32(uint256(1)));
    ...
    function test_GameIntegration_PlayerBanned_AppLevel() public {
        ...
        vm.prank(owner);
        banManager.banFromApp(player1AgentId, APP_ID, "Game-specific violation", bytes32(uint256(2)));
