...
contract ReputationLabelManagerTest is Test {
    ...
    function test_ProposeHackerLabel() public {
        ...
        vm.prank(proposer1);
        bytes32 proposalId =
            labelManager.proposeLabel{value: stake}(100, ReputationLabelManager.Label.HACKER, EVIDENCE_1);
    ...
    function test_ProposeLabel_InsufficientStake() public {
        ...
        labelManager.proposeLabel{value: 0.01 ether}(100, ReputationLabelManager.Label.HACKER, EVIDENCE_1); // Requires 0.1 ETH
    }
    ...
    function test_ResolveProposal_Approved() public {
        ...
        vm.prank(proposer1);
        bytes32 proposalId =
            labelManager.proposeLabel{value: 0.1 ether}(100, ReputationLabelManager.Label.SCAMMER, EVIDENCE_1);
    ...
    function test_ResolveProposal_Rejected() public {
        ...
        vm.prank(proposer1);
        bytes32 proposalId =
            labelManager.proposeLabel{value: 0.05 ether}(200, ReputationLabelManager.Label.SCAMMER, EVIDENCE_2);
    ...
    function test_HackerLabel_AutoBan() public {
        ...
        vm.prank(proposer1);
        bytes32 proposalId =
            labelManager.proposeLabel{value: 0.1 ether}(300, ReputationLabelManager.Label.HACKER, EVIDENCE_1);
    ...
    function test_MultipleLabelsPerAgent() public {
        ...
        vm.prank(proposer1);
        bytes32 proposal1 =
            labelManager.proposeLabel{value: 0.05 ether}(400, ReputationLabelManager.Label.SCAMMER, EVIDENCE_1);

        // Propose SPAM_BOT
        vm.prank(proposer2);
        bytes32 proposal2 =
            labelManager.proposeLabel{value: 0.01 ether}(400, ReputationLabelManager.Label.SPAM_BOT, EVIDENCE_2);
    ...
    function test_RemoveLabel() public {
        ...
        vm.prank(proposer1);
        bytes32 proposalId =
            labelManager.proposeLabel{value: 0.05 ether}(500, ReputationLabelManager.Label.SCAMMER, EVIDENCE_1);
    ...
    function test_CannotProposeDuplicateLabel() public {
        ...
        vm.prank(proposer1);
        bytes32 proposal1 =
            labelManager.proposeLabel{value: 0.05 ether}(600, ReputationLabelManager.Label.SCAMMER, EVIDENCE_1);
        ...
        labelManager.proposeLabel{value: 0.05 ether}(600, ReputationLabelManager.Label.SCAMMER, EVIDENCE_2);
    }
    ...
    function test_TrustedLabel() public {
        vm.prank(proposer1);
        bytes32 proposalId =
            labelManager.proposeLabel{value: 0.5 ether}(700, ReputationLabelManager.Label.TRUSTED, EVIDENCE_1);
    ...
    function test_ProposeLabel_InvalidLabel() public {
        ...
        labelManager.proposeLabel{value: 0.1 ether}(800, ReputationLabelManager.Label.NONE, EVIDENCE_1);
    }
    ...
    function test_ResolveProposal_VotingNotEnded() public {
        vm.prank(proposer1);
        bytes32 proposalId =
            labelManager.proposeLabel{value: 0.05 ether}(1000, ReputationLabelManager.Label.SCAMMER, EVIDENCE_1);
    ...
    function test_ResolveProposal_MarketNotResolved() public {
        vm.prank(proposer1);
        bytes32 proposalId =
            labelManager.proposeLabel{value: 0.05 ether}(1100, ReputationLabelManager.Label.SCAMMER, EVIDENCE_1);
    ...
    function test_Pause() public {
        ...
        vm.prank(proposer1);
        vm.expectRevert();
        labelManager.proposeLabel{value: 0.1 ether}(1200, ReputationLabelManager.Label.HACKER, EVIDENCE_1);
    }
}
