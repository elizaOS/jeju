...
contract ReportingSystemTest is Test {
    ...
    function test_GetReportsByTarget() public {
        ...
        reportingSystem.submitReport{value: 0.001 ether}(
            800, ReportingSystem.ReportType.APP_BAN,
            ReportingSystem.ReportSeverity.LOW,
            HYPERSCAPE_APP, EVIDENCE_HASH, "Report 1"
        );
        
        reportingSystem.submitReport{value: 0.01 ether}(
            800, ReportingSystem.ReportType.LABEL_SCAMMER,
            ReportingSystem.ReportSeverity.MEDIUM,
            BAZAAR_APP, EVIDENCE_HASH, "Report 2"
        );
    ...
    function test_GetReportsByReporter() public {
        vm.prank(reporter1);
        reportingSystem.submitReport{value: 0.001 ether}(
            900, ReportingSystem.ReportType.APP_BAN,
            ReportingSystem.ReportSeverity.LOW,
            HYPERSCAPE_APP, EVIDENCE_HASH, "Report 1"
        );
        ...
        vm.prank(reporter1);
        reportingSystem.submitReport{value: 0.001 ether}(
            901, ReportingSystem.ReportType.APP_BAN,
            ReportingSystem.ReportSeverity.LOW,
            HYPERSCAPE_APP, EVIDENCE_HASH, "Report 2"
        );
    ...
    function test_AllReportTypes() public {
        ...
        (uint256 r1,) = reportingSystem.submitReport{value: 0.01 ether}(
            1200, ReportingSystem.ReportType.NETWORK_BAN,
            ReportingSystem.ReportSeverity.MEDIUM,
            HYPERSCAPE_APP, EVIDENCE_HASH, "Network ban"
        );
        
        // APP_BAN
        (uint256 r2,) = reportingSystem.submitReport{value: 0.001 ether}(
            1201, ReportingSystem.ReportType.APP_BAN,
            ReportingSystem.ReportSeverity.LOW,
            HYPERSCAPE_APP, EVIDENCE_HASH, "App ban"
        );
        
        // LABEL_HACKER
        (uint256 r3,) = reportingSystem.submitReport{value: 0.05 ether}(
            1202, ReportingSystem.ReportType.LABEL_HACKER,
            ReportingSystem.ReportSeverity.HIGH,
            HYPERSCAPE_APP, EVIDENCE_HASH, "Hacker label"
        );
        
        // LABEL_SCAMMER
        (uint256 r4,) = reportingSystem.submitReport{value: 0.01 ether}(
            1203, ReportingSystem.ReportType.LABEL_SCAMMER,
            ReportingSystem.ReportSeverity.MEDIUM,
            BAZAAR_APP, EVIDENCE_HASH, "Scammer label"
        );
...
contract MockPredimarket {
    ...
    function getMarket(bytes32 sessionId) external view returns (
        ...
        return (
            sessionId, "Test", 0, 0, 1000 ether, 0, block.timestamp,
