...
contract ContestIntegrationTest is Test {
    ...
    function testCompleteContestWithBetting() public {
        ...
        bytes32 contestId = contest.announceContest(
            testOptions,
            startTime,
            IPredictionOracle.ContestMode.SINGLE_WINNER
        );
    ...
    function testMultipleRacesWithDifferentOutcomes() public {
        ...
        bytes32 contestId1 = contest.announceContest(testOptions, startTime1, IPredictionOracle.ContestMode.SINGLE_WINNER);
        ...
        bytes32 contestId2 = contest.announceContest(testOptions, startTime2, IPredictionOracle.ContestMode.SINGLE_WINNER);
