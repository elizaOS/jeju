...
contract CreditPurchaseContractTest is Test {
    ...
    function setUp() public {
        ...
        purchase = new CreditPurchaseContract(elizaToken, IPriceOracle(address(oracle)), treasury);
    ...
    function testConstructor_RevertsOnZeroElizaOS() public {
        ...
        new CreditPurchaseContract(MockElizaOSToken(address(0)), IPriceOracle(address(oracle)), treasury);
    }

    function testConstructor_RevertsOnZeroOracle() public {
        vm.expectRevert(CreditPurchaseContract.InvalidPriceOracle.selector);
        new CreditPurchaseContract(elizaToken, IPriceOracle(address(0)), treasury);
    }

    function testConstructor_RevertsOnZeroTreasury() public {
        vm.expectRevert(CreditPurchaseContract.InvalidTreasury.selector);
        new CreditPurchaseContract(elizaToken, IPriceOracle(address(oracle)), address(0));
    }
    ...
    function testGetQuote_RevertsOnUnsupportedToken() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(CreditPurchaseContract.UnsupportedToken.selector, unsupported));
    ...
    function testPurchaseCredits_WithUSDC() public {
        ...
        uint256 creditsReceived = purchase.purchaseCredits(address(usdc), paymentAmount, 0, user);
        vm.stopPrank();
    ...
    function testPurchaseCredits_RevertsWhenPaused() public {
        ...
        purchase.purchaseCredits{value: 1 ether}(address(0), 1 ether, 0, user);
    }
    ...
    function testSetPlatformFee_RevertsIfTooHigh() public {
        vm.expectRevert(abi.encodeWithSelector(CreditPurchaseContract.InvalidFee.selector, 1001));
