...
library Equipment {
     ...
     */
    function set(address player, uint16 weapon, uint16 shield, uint16 helmet, uint16 body, uint16 legs, uint16 arrows)
        internal
    {
     ...
     * @notice Set the full data using individual values.
     */
    function _set(address player, uint16 weapon, uint16 shield, uint16 helmet, uint16 body, uint16 legs, uint16 arrows)
        internal
    {
        bytes memory _staticData = encodeStatic(weapon, shield, helmet, body, legs, arrows);
    ...
    function set(address player, EquipmentData memory _table) internal {
        bytes memory _staticData =
            encodeStatic(_table.weapon, _table.shield, _table.helmet, _table.body, _table.legs, _table.arrows);
    ...
    function decodeStatic(bytes memory _blob)
        internal
        pure
        returns (uint16 weapon, uint16 shield, uint16 helmet, uint16 body, uint16 legs, uint16 arrows)
    {
    ...
    function decode(bytes memory _staticData, EncodedLengths, bytes memory)
        internal
        pure
        returns (EquipmentData memory _table)
    {
        (_table.weapon, _table.shield, _table.helmet, _table.body, _table.legs, _table.arrows) =
     ...
     */
    function encodeStatic(uint16 weapon, uint16 shield, uint16 helmet, uint16 body, uint16 legs, uint16 arrows)
        internal
        pure
     ...
     */
    function encode(uint16 weapon, uint16 shield, uint16 helmet, uint16 body, uint16 legs, uint16 arrows)
        internal
        pure
