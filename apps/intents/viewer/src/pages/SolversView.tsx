...
import { useSolvers, useSolverLeaderboard } from '../hooks/useOIF';
import type { Solver } from '../../../../../types/oif';
          ...
          {leaderboard?.slice(0, 5).map((entry, index) => (
            <div
              ...
              style={{
                ...
                padding: '12px 16px',
                background: index === 0 ? 'linear-gradient(90deg, var(--accent-cyan)10, transparent)' : 'var(--bg-tertiary)',
                borderRadius: '8px',
                border: index === 0 ? '1px solid var(--accent-cyan)30' : '1px solid transparent',
              }}
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                <div style={{
                  ...
                  height: '28px',
                  borderRadius: '50%',
                  background: index === 0 ? 'var(--accent-cyan)' : 'var(--bg-secondary)',
                  display: 'flex',
                  alignItems: 'center',
              ...
              <div style={{ display: 'flex', gap: '32px', alignItems: 'center' }}>
                ...
                <div style={{ textAlign: 'right' }}>
                  <div style={{ fontSize: '14px', fontWeight: 600 }}>{entry.totalFills}</div>
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '20px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          ...
          <div>
            <div style={{ fontWeight: 600, fontSize: '16px' }}>{solver.name}</div>
            <div style={{ fontSize: '12px', fontFamily: 'var(--font-mono)', color: 'var(--text-secondary)' }}>
