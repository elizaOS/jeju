...
contract ValidationRegistryTest is Test {
    ...
    function testMultipleValidationRequests() public {
        ...
        validationRegistry.validationRequest(
            stakeValidator,
            serviceId,
            "ipfs://stake-validation",
            keccak256("stake-data")
        );
    ...
    function testTEEAttestationWorkflow() public {
        ...
        (, , uint8 validationScore, bytes32 attestationType, ) = 
            validationRegistry.getValidationStatus(requestHash);
    ...
    function testTEEAttestationRegistry() public {
        ...
        validationRegistry.validationRequest(
            teeValidator,
            teeServiceId,
            "ipfs://tee-service-code",
            keccak256("attestation-service-code")
        );
        ...
        validationRegistry.validationResponse(
            requestHash,
            100,
            "ipfs://enclave-measurement-report",
            keccak256("mrenclave-hash"),
            bytes32("sgx-attested")
        );
    ...
    function testApplicationValidationPipeline() public {
        ...
        validationRegistry.validationRequest(
            teeValidator,
            defiApp,
            "ipfs://tee-security-audit",
            keccak256("security-audit")
        );
        ...
        validationRegistry.validationRequest(
            ...
            defiApp,
            "ipfs://zkml-proof",
            keccak256("zkml-verification")
        );
        
        validationRegistry.validationRequest(
            stakeValidator,
            defiApp,
            "ipfs://stake-based-audit",
            keccak256("audit-data")
        );
        vm.stopPrank();
        ...
        vm.prank(teeValidator);
        validationRegistry.validationResponse(validations[0], 100, "ipfs://tee-report", bytes32(0), bytes32("tee-secure"));
        
        vm.prank(zkMLValidator);
        validationRegistry.validationResponse(validations[1], 95, "ipfs://zkml-proof", bytes32(0), bytes32("zkml-proven"));
