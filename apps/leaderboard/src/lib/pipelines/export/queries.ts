...
export async function getTopPullRequests(params: QueryParams = {}, limit = 5, db: DbInstance = defaultDb) {
...
export async function getTopIssues(params: QueryParams = {}, limit = 5, db: DbInstance = defaultDb) {
...
export async function getTopContributors(params: QueryParams = {}, limit = 5, db: DbInstance = defaultDb) {
...
export async function getRepoMetrics(params: QueryParams = {}, db: DbInstance = defaultDb) {
