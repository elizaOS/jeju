...
contract DeployOIF is Script {
    function run() external {
        ...
        InputSettler inputSettler = new InputSettler(
            chainId,
            oracleAddr,
        ...
        console.log("");
        console.log(string.concat("OIF_SOLVER_REGISTRY_", vm.toString(chainId), "=", vm.toString(address(solverRegistry))));
        ...
        console.log(string.concat("OIF_OUTPUT_SETTLER_", vm.toString(chainId), "=", vm.toString(address(outputSettler))));
    }
}
...
contract ConfigureOIFRoutes is Script {
    function run() external {
        ...
        address solverRegistry = vm.envAddress("OIF_SOLVER_REGISTRY");
