...
library Player {
    // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "hyperscape", name: "Player", typeId: RESOURCE_TABLE });`
    ResourceId constant _tableId = ResourceId.wrap(0x74626879706572736361706500000000506c6179657200000000000000000000);
    ...
    // Hex-encoded value schema of (bool, uint256, uint256, string)
    Schema constant _valueSchema = Schema.wrap(0x00410301601f1fc5000000000000000000000000000000000000000000000000);
     ...
     * @notice Get exists.
     */
    function getExists(address player) internal view returns (bool exists) {
     ...
     * @notice Get exists.
     */
    function _getExists(address player) internal view returns (bool exists) {
        bytes32[] memory _keyTuple = new bytes32[](1);
        _keyTuple[0] = bytes32(uint256(uint160(player)));
     ...
     * @notice Set exists.
     */
    function setExists(address player, bool exists) internal {
        bytes32[] memory _keyTuple = new bytes32[](1);
        _keyTuple[0] = bytes32(uint256(uint160(player)));
     ...
     * @notice Set exists.
     */
    function _setExists(address player, bool exists) internal {
        bytes32[] memory _keyTuple = new bytes32[](1);
        _keyTuple[0] = bytes32(uint256(uint160(player)));
     ...
     */
    function getCreatedAt(address player) internal view returns (uint256 createdAt) {
        bytes32[] memory _keyTuple = new bytes32[](1);
        _keyTuple[0] = bytes32(uint256(uint160(player)));
     ...
     * @notice Get createdAt.
     */
    function _getCreatedAt(address player) internal view returns (uint256 createdAt) {
        bytes32[] memory _keyTuple = new bytes32[](1);
        _keyTuple[0] = bytes32(uint256(uint160(player)));
     ...
     */
    function setCreatedAt(address player, uint256 createdAt) internal {
        bytes32[] memory _keyTuple = new bytes32[](1);
        _keyTuple[0] = bytes32(uint256(uint160(player)));
     ...
     * @notice Set createdAt.
     */
    function _setCreatedAt(address player, uint256 createdAt) internal {
        bytes32[] memory _keyTuple = new bytes32[](1);
        _keyTuple[0] = bytes32(uint256(uint160(player)));
     ...
     */
    function getLastLogin(address player) internal view returns (uint256 lastLogin) {
        bytes32[] memory _keyTuple = new bytes32[](1);
        _keyTuple[0] = bytes32(uint256(uint160(player)));
     ...
     * @notice Get lastLogin.
     */
    function _getLastLogin(address player) internal view returns (uint256 lastLogin) {
        bytes32[] memory _keyTuple = new bytes32[](1);
        _keyTuple[0] = bytes32(uint256(uint160(player)));
     ...
     */
    function setLastLogin(address player, uint256 lastLogin) internal {
        bytes32[] memory _keyTuple = new bytes32[](1);
        _keyTuple[0] = bytes32(uint256(uint160(player)));

        StoreSwitch.setStaticField(_tableId, _keyTuple, 2, abi.encodePacked((lastLogin)), _fieldLayout);
    }

    /**
     * @notice Set lastLogin.
     */
    function _setLastLogin(address player, uint256 lastLogin) internal {
        bytes32[] memory _keyTuple = new bytes32[](1);
        _keyTuple[0] = bytes32(uint256(uint160(player)));

        StoreCore.setStaticField(_tableId, _keyTuple, 2, abi.encodePacked((lastLogin)), _fieldLayout);
    }
     ...
     */
    function set(address player, bool exists, uint256 createdAt, uint256 lastLogin, string memory name) internal {
        bytes memory _staticData = encodeStatic(exists, createdAt, lastLogin);
     ...
     * @notice Set the full data using individual values.
     */
    function _set(address player, bool exists, uint256 createdAt, uint256 lastLogin, string memory name) internal {
        bytes memory _staticData = encodeStatic(exists, createdAt, lastLogin);
    ...
    function set(address player, PlayerData memory _table) internal {
        bytes memory _staticData = encodeStatic(_table.exists, _table.createdAt, _table.lastLogin);
    ...
    function decodeStatic(bytes memory _blob)
        internal
        pure
        returns (bool exists, uint256 createdAt, uint256 lastLogin)
    {
        exists = (_toBool(uint8(Bytes.getBytes1(_blob, 0))));

        createdAt = (uint256(Bytes.getBytes32(_blob, 1)));

        lastLogin = (uint256(Bytes.getBytes32(_blob, 33)));
    }
    ...
    {
        (_table.exists, _table.createdAt, _table.lastLogin) = decodeStatic(_staticData);
     ...
     */
    function encodeStatic(bool exists, uint256 createdAt, uint256 lastLogin) internal pure returns (bytes memory) {
        return abi.encodePacked(exists, createdAt, lastLogin);
    }
     ...
     */
    function encode(bool exists, uint256 createdAt, uint256 lastLogin, string memory name)
        internal
        pure
