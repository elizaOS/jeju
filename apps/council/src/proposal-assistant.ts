...
export class ProposalAssistant {
  constructor(_blockchain: CouncilBlockchain) {} // Reserved for future content indexing
...
export function getProposalAssistant(blockchain: CouncilBlockchain): ProposalAssistant {
