...
import { getChainStats, getEndpointHealth } from '../../src/proxy/rpc-proxy';
import { isChainSupported, getChain, CHAINS } from '../../src/config/chains';
...
describe('Endpoint Health', () => {
  test('returns health for all chains', () => {
    ...
    // Should have entries for primary endpoints at minimum
